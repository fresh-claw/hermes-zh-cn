...
7. 安装器检测 Hermes 程序目录，备份后修改 `hermes_cli/banner.py`、`hermes_cli/skin_engine.py`、`hermes_cli/tips.py`、`hermes_cli/commands.py` 等文件，并中文显示启动标题、原版风格点阵标识、快捷指令、工具集与技能分类。
