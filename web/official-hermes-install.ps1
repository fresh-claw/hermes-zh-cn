...
#
# Usage:
#   iex (irm http://47.121.138.43/hermes/official-hermes-install.ps1)
#
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'http://47.121.138.43/hermes/official-hermes-install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
